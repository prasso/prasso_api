...
@if ($step1)
  ...
  <div class="step  inset-0  ease-out duration-400" id="step-2">
    ...
    <label for="domain-name">Domain Name: (example - one word no spaces - yourbusinessname) we will add faxt.com to this</label>
...
@if ($step4)
  ...
  <div class="step  inset-0  ease-out duration-400" id="step-4">
    ...
    @include('sites.site-inputs', ['team_selection' => $team_selection, 'show_buttons' => false])
