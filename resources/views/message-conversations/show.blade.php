<x-app-layout :site="$site ?? null">
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <a href="{{ route('filament.site-admin.resources.msg-deliveries.index') }}" 
               class="text-blue-600 hover:text-blue-800">
                ← Back to Messages
            </a>
            <a href="{{ route('message-conversations.export', ['messageId' => $message->id]) }}" 
        ...
        <h1 class="text-3xl font-bold text-gray-900 mt-2">Message Conversation</h1>
    </x-slot>
