...
<<<<<<< HEAD
          ...
          <div id="icd7x" class="cell gpd-navbar__menu">
            <a id="iy344" class="gpd-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<section id="i6n844" data-anim-type="fadeIn" class="gpd-section">
  <div id="iaa0jf" class="gpd-container">
    ...
    <div id="i85ryr" class="footer-socials">
      ...
      <a href="" id="i91sl" class="gpd-link-box"><span id="io3eq" class="gpd-icon footer-link-svg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4c0 3.2-2.6 5.8-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8C2 4.6 4.6 2 7.8 2m-.2 2C5.61 4 4 5.61 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8c1.99 0 3.6-1.61 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4H7.6m9.65 1.5a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 7c2.76 0 5 2.24 5 5s-2.24 5-5 5-5-2.24-5-5 2.24-5 5-5m0 2c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z">
        </path>
        </svg></span></a>
      <a href="" id="i4fgn" class="gpd-link-box"><span id="iud9y" class="gpd-icon footer-link-svg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <a href="" id="i8bfk" class="gpd-link-box"><span id="iozha" class="gpd-icon footer-link-svg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        <path d="M3 4c-1.11 0-2 .89-2 2v12c0 1.1.9 2 2 2h11v-2H3V8.37l8 4.99 8-4.99V13h2V6c0-1.1-.9-2-2-2H3m0 2h16l-8 5-8-5m16 9v3h-3v2h3v3h2v-3h3v-2h-3v-3h-2z">
        </path>
        </svg></span></a>
    </div>
  </div>
...
<script>var items = document.querySelectorAll('#iy344');
...
=======
            <h1 class="gpd-header" id="ijmpwv">Welcome  </h1>
          </div>
          <p class="gpd-header">Configure your site</p>
        </div>
      </div>
    </div>
</div> 
<div id="im2ax9" class="gpd-container">
  <image src="https://avatars.githubusercontent.com/u/543334?v=4"  class="gpd-header"/>
</div> 
</section>
>>>>>>> fed70f39e041b0a588ff9a8cff6dd2309c1f8134
