...
<section class="text-gray-700 body-font">
    <div class="container px-8 pt-20 pb-4 mx-auto lg:px-4">
        <div class="flex flex-col w-full mb-12 text-left ">
            ...
            <h2 class="mb-1 font-semibold tracking-widest text-blue-600 title-font mb-30">
            ...
            <h2 class="mb-1 font-semibold tracking-widest text-blue-600 uppercase title-font justify-center"> Goals</h2>
...
<h2 class="mb-1 font-semibold tracking-widest text-blue-600 uppercase title-font justify-center"> Solution</h2>
            <p class="mx-auto text-base font-medium leading-relaxed text-gray-700 lg:w-2/3">
