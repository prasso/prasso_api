...
<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
    <div class="p-6 bg-white border-b border-gray-200">
        <div class="py-2">
            <a class="cursor-pointer rounded-xl transition duration-500 ease-in-out transform rounded-lg shadow-xl"
                href="{{ route('image.library', ['site_id' => $site_id]) }}" title="Image Library">
                <i alt="image library" class="material-icons">photo_library</i>
            </a>
        </div>
